...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    filters: Schema.Attribute.Component<'product.filter', true>;
...
export interface ApiQuoteRequestQuoteRequest
  ...
  attributes: {
    catalogItems: Schema.Attribute.Component<'quote.item', true>;
    companyName: Schema.Attribute.String;
    country: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customDesigns: Schema.Attribute.Component<'quote.custom-design', true>;
    customerName: Schema.Attribute.String & Schema.Attribute.Required;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    generalNotes: Schema.Attribute.RichText;
    internalNotes: Schema.Attribute.RichText & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    quotedAmount: Schema.Attribute.Decimal;
    quoteNumber: Schema.Attribute.String & Schema.Attribute.Unique;
    shippingNotes: Schema.Attribute.String;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Static images and settings used across the website. Each field has a description showing where the image appears.';
  ...
  attributes: {
    ...
    customDesignHeroImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    fallbackCategoryImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    fallbackProductImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    imageGuide: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    ourStoryGallery: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    ourStoryHeroImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wholesaleHeroImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
